use core::{buffers::buffer::{Buffer, BufferDataInterface, Usage}, context::synchronization_context::{BufferUpdateBarrier, CommandBarrier, ShaderStorageBarrier}, textures::{texture::TextureAccess, TextureUnit}, GL};
use std::ffi::c_void;
...
impl CubeMarcher for BlockCubeMarcher {
    fn march<'a>(&mut self, params: &mut MarchParameters) {
         ...
         params.sync_context.force_sync_with(ShaderStorageBarrier);
